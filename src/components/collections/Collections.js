...
import "../../index.css"
import homeBannerMobile from "../../static/media/llp-home-banner-mobile.39489c47.png";
import homeBannerDesktop from "../../static/media/llp-home-banner-desktop.da12bd2c.png";
import icon from "../../static/media/rating-icon.621499fc.svg";
import villachaloinfinity from "../../image/villachaloinfity.png";
import { BiLeftArrow, BiRightArrow } from 'react-icons/bi';

function Collections() {
    return (
        <>
            <div class="home-module__section___T-dDa">
                <a id="locations" class="property-location-module__anchor___kO01J"></a>
                <h2 class="home-module__sectionTitle___0k8HH">Explore Lohono</h2>
                <div class="home-module__sectionSubtitle___Cz0CG">Exclusive homes for rent spread across pristine destinations, pick your nest of luxury</div>
                <div class="property-location-module__propertyTitle___-Hqg3">Domestic Properties</div>
                ...
                <div class="property-location-module__propertyTitle___-Hqg3">International Properties</div>
                <div class="property-location-module__container___LpNcO home-module__sectionContent___UmJtY">
            ...
            <div class="loyalty-point-module__container___FDOwU home-module__section___T-dDa">
                <picture class="img-module__picture___wiM80 loyalty-point-module__banner___eYxrI">
                    <source media="(max-width: 768px)" srcSet={homeBannerMobile} />
                    <source media="(min-width: 768px)" srcSet={homeBannerDesktop} />
                    <img src={homeBannerDesktop} loading="lazy" alt="Lohono" class="img-module__image___Kpwp0 image" />
                </picture>
                <img src={villachaloinfinity} alt="Infinity Image Home" class="loyalty-point-module__infinityImageHome___MEUyE" />
                <div class="loyalty-point-module__header___GLTF2">The Loyalty Program</div>
                <a href="loyalty-points.html" target="_blank" rel="noreferrer noopener" class="button-module__button___k-ikH loyalty-point-module__details___y8qk5">Know More</a>
                <div class="loyalty-point-module__bottomtext___n8HWZ">Book your next dream villa to earn points and redeem exclusive deals on your next stay.</div>
            </div>
            <div class="recommendation-module__section___72pii home-module__section___T-dDa">
                <div class="home-module__sectionTitle___0k8HH recommendation-module__placeholder___8jqci">Trending this season</div>
                <div class="home-module__sectionSubtitle___Cz0CG recommendation-module__placeholder___8jqci">Our homes have been reviewed by a number of critics and publications. Check out our private villas trending this summer!</div>
                <div class="carousel-module__container___hwZe1 recommendation-module__carousel___LmPym home-module__sectionContentCollapse___T9jZf" id="trending-properties">
                    <span class="carousel-module__adjust___Qg4aF"></span>
                    <div class="recommendation-module__item___velyy" data-index="0">
                        <a href="villas/india/coonoor/amani-villas-8b.html" class="recommendation-module__property___sVkIg" title="Amani Villas 8B ">
                            ...
                            <div class="recommendation-module__ratings___yOc2f"></div>
                            <div class="recommendation-module__list___T7arV">
                                <div>Start from <span class="recommendation-module__strike___07s3H">₹ 25,700</span>
                                </div>
                                <span class="recommendation-module__rate___ovxjF">₹ 20,560</span>/ night* (*Exclusive of taxes)
                            </div>
                        </a>
                    </div>
                    <div class="recommendation-module__item___velyy" data-index="1">
                        <a href="villas/india/goa/villa-feliz.html" class="recommendation-module__property___sVkIg" title="Villa Feliz">
                            ...
                            <div class="recommendation-module__logoratingcounts___zhVmE"></div>
                            <div class="recommendation-module__list___T7arV">
                                <div>Start from</div>
                                <span class="recommendation-module__rate___ovxjF">₹ 42,100</span>/ night* (*Exclusive of taxes)
                            </div>
                        </a>
                    </div>
                    <div class="recommendation-module__item___velyy" data-index="2">
                        <a href="villas/india/gurgaon/beri-house.html" class="recommendation-module__property___sVkIg" title="Sadhrana Bagh - Beri House">
                            ...
                            <div class="recommendation-module__ratings___yOc2f">
                                <div class="rating-counts-module__recommendationRating___2ZlJp">
                                    <img src={icon} alt="icon" class="rating-counts-module__ratingIcon___cBoCk" />
                                    <span class="rating-counts-module__avgRating___XkGAR">5</span>
                                    <span class="rating-counts-module__ratingCount___zrNrH">(5)</span>
                                </div>
                            </div>
                            <div class="recommendation-module__list___T7arV">
                                <div>Start from</div>
                                <span class="recommendation-module__rate___ovxjF">₹ 48,000</span>/ night* (*Exclusive of taxes)
                            </div>
                        </a>
                    </div>
                    <span class="carousel-module__adjust___Qg4aF"></span>
                </div>
                <div class="scroller-module__scroller___ewlbN recommendation-module__scroller___RVdZK">
                    <BiLeftArrow  alt="scroll-left" class="scroller-module__scrollIcon___Zr+9p" />
                    <BiRightArrow div alt="scroll-right" class="scroller-module__scrollIcon___Zr+9p" />
                </div>
            </div>
            {/* <div class="homeowner-module__container___mDZbR home-module__section___T-dDa">
                <img src="static/media/home-illustration.e7bcc0b4.html" alt="isprava-api" class="homeowner-module__illustration___HdJE-" loading="lazy" />
                <img src="static/media/lohono-calligraphy.4188985b.html" alt="lohono-logo" class="homeowner-module__calligraphy___H7FdE" loading="lazy" />
                <h2 class="homeowner-module__title___ydTH1">Partner as a Homeowner</h2>
                <div class="homeowner-module__subtitle___yQqSp">If you own a beautiful, one of a kind home that you feel exudes exclusivity and fits the Lohono style and vibe, register here to list with us!</div>
                <button class="button-module__button___k-ikH homeowner-module__contact___Hj98N">Contact us</button>
            </div> */}
            <div class="home-module__spacer___6-z3h"></div>
